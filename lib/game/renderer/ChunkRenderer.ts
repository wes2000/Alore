...
const NODE_ART: Record<string, { p: string[]; pal: Palette }> = {
  OakTree: {
    ...
    pal: { d: '#1a3a08', G: '#3a7a18', l: '#5aaa28', B: '#7a4a20', s: '#0a1a04' },
  },
  BirchTree: {
    p: [
      '...dLLd.',
    ...
    pal: { d: '#2a5010', L: '#6a9a30', l: '#8aca40', W: '#e8e0c0', w: '#c8b890', s: '#1a3008' },
  },
  WillowTree: {
    p: [
      '..ddWWd.',
    ...
    pal: { d: '#1a3830', W: '#407840', w: '#60a860', B: '#604820', b: '#402a10', v: '#305030', s: '#0a1808' },
  },
  StoneBoulder: {
    p: [
      '..dDDd..',
    ...
    pal: { d: '#505050', D: '#383838', L: '#909090', h: '#b8b8b8', l: '#b0b0b0', s: '#282828' },
  },
  CopperOre: {
    p: [
      '..dDDd..',
    ...
    pal: { d: '#505058', D: '#383840', L: '#808090', l: '#9090a0', o: '#e09060', C: '#a86030', s: '#282830', S: '#f8c888' },
  },
  IronOre: {
    p: [
      '..dDDd..',
    ...
    pal: { d: '#505058', D: '#303038', i: '#8090a0', I: '#a0b0c0', S: '#c8d8e8', s: '#202028' },
  },
  GoldOre: {
    p: [
      '..dDDd..',
    ...
    pal: { d: '#504840', D: '#383028', L: '#888070', G: '#e8c020', g: '#f8e040', S: '#fff880', s: '#201808' },
  },
  MithrilOre: {
    p: [
      '..dDDd..',
    ...
    pal: { d: '#384050', D: '#202830', L: '#607080', l: '#708090', M: '#5090e0', m: '#80b8f8', S: '#b0e0ff', s: '#101820' },
  },
  HerbPatch: {
    p: [
      '.f.f.f..',
    ...
    pal: { f: '#e8d020', S: '#60c840', s: '#308020', g: '#184010' },
  },
  MushroomCluster: {
    p: [
      '.DRRRDhD',
    ...
    pal: { D: '#601010', R: '#d82020', d: '#401010', W: '#f0f0f0', w: '#d0c8c0', S: '#e8e8d0', h: '#801010' },
  },
  FishingSpot: {
    p: [
      '..r.....',
    ...
    pal: { b: '#2060a0', w: '#60b8e0', W: '#c0e8ff', r: '#80d0f0' },
  },
}
