...
export const ITEM_DEFINITIONS: Record<string, ItemDefinition> = {
  ...
  feather:      { id: 'feather',      name: 'Feather',      description: 'A light plume feather.',        type: ItemType.Resource, rarity: ItemRarity.Common,   stackable: true, maxStack: 200, value: 3,   icon: '🕊️' },
